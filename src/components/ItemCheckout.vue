    ...
    <div class="checkout-item mt-20 flex-col">
      <div class="flex-col">
        <div class="flex-row items-center">
          ...
          <h3 class="text-md text-bold ml-5">Grosir Kerudung & Masker</h3>
        </div>
        <p class="mt-10 text-soft-gray">Kab. Bekasi</p>
      </div>
      <div class="flex-row justify-between">
        <div class="flex-row mt-20 w-60">
          ...
          <div class="ml-10">
            <h3 class="text-md text-bold">Masker</h3>
            <p class="mt-15 text-md text-bold text-red">Rp2.350</p>
            <p class="mt-10 text-md text-soft-gray">1 barang(12gr)</p>
      ...
      <div class="flex-col mt-10">
        <div class="total-dropdown flex-row justify-between">
          ...
          <div @click="isTotalOpen = !isTotalOpen" class="flex-row justify-center items-center">
            <p class="text-lg text-bold text-red">Rp.20.000 </p>
        ...
        <div :class="isTotalOpen ? 'flex-col' : 'hidden'">
          <div class="mt-10 flex-row justify-between">
            ...
            <p class="text-sm text-bold">Rp.20.000</p>
          </div>
          <div class="mt-10 flex-row justify-between">
